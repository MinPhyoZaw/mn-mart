        ...
        {isLoading ? (
          ...
          <div className={gridClasses}>
            {shops.map((shop) => (
              <div
                key={shop._id}
                className="bg-white rounded-xl overflow-hidden border border-gray-200 hover:shadow-lg transition w-full"
              >
                {isTransportation ? (
                  <>
                  ...
                  <>
                    ...
                    <div className="p-4 md:p-5">
                      ...
                      <p className="text-sm text-gray-600 line-clamp-3 mb-4">{shop.description}</p>

                      <Link
                        href={`/shops/${shop._id}`}
                        className="inline-block w-full text-center bg-green-600 text-white text-sm py-2.5 rounded-lg hover:bg-green-700 transition"
                      >
                        {ctaLabel}
                      </Link>
                    </div>
